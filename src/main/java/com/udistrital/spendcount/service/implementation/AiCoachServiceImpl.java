...
import com.udistrital.spendcount.repository.AiCoachRequestRepository;
...
import com.udistrital.spendcount.service.OpenAiClientService;
...
public class AiCoachServiceImpl implements AiCoachService {
    ...
    /**
     * Allows to request financial advice from the AI coach based on user financial history,
     * financial goal and previous AI coach requests related to the same financial goal.
     *
     * @param userDocumentNumber document number of the user requesting financial advice
     * @param financialGoalId id of the financial goal associated with the advice request
     * @param question question asked by the user
     * @return AiCoachRequest object saved with the AI response
     */
    @Override
    ...
    /**
     * Allows to get an AI coach request by id.
     *
     * @param aiCoachRequestId id of the AI coach request to find
     * @return AiCoachRequest object found
     */
    @Override
    ...
    /**
     * Builds the summarized financial context used by the AI coach.
     *
     * @param userDocumentNumber document number of the user
     * @param financialGoal financial goal associated with the request
     * @param previousAiCoachRequests previous AI coach requests related to the same financial goal
     * @param question question asked by the user
     * @return summarized financial context
     */
    ...
    /**
     * Builds the final prompt sent to OpenAI.
     *
     * @param financialContext summarized financial context
     * @param question user question
     * @return prompt to send to OpenAI
     */
    ...
    /**
     * Limits a text to avoid sending an excessive prompt to OpenAI.
     *
